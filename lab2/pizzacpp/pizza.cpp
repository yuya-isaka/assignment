                ...
                if(percentage_cheese_pizza >= 0){
                    ...
                    if(cost_cheese_pizza >= 0){
                        ...
                        if(cost_combination_pizza){
                            ...
                            cout << "パーティーに来られるおきゃくさまの数は" << number_people << "名様で、1人" << number_person_pizza << "枚のピザを食べられるということですので、全体で頼むスライスピザの数は" << number_all_pizza << "枚で、ピザの数は" << number_all_all_pizza << "枚でございます。" << endl;
